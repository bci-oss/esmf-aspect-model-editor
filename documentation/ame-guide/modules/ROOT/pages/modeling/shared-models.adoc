...
The concept of "shared models" has been introduced in the Aspect Model Editor with version xxx.
It supports you to define model parts, which can be reused in multiple other models.
...
Such a model can be referenced from multiple other models and Aspect Models.
